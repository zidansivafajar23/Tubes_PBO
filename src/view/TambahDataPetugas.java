...
public class TambahDataPetugas extends javax.swing.JDialog {
    ...
    /**
     * Creates new form TambahDataPetugas
     */
    User user;
    
    public TambahDataPetugas(java.awt.Frame parent, boolean modal, User user) {
        super(parent, modal);
        this.user = user;
        initComponents();
    ...
    private void SimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SimpanActionPerformed
        ...
        if (user instanceof KepalaPerpus) {
            ...
            boolean added = pengurus.tambahDataPetugas(usernameValue, passwordValue, namaValue, alamatValue, tanggalLahir, teleponValue);
            if (added) {
                JOptionPane.showMessageDialog(this, "Data petugas berhasil ditambahkan!");
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(this, "Gagal menambahkan data petugas.");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TambahDataPetugas dialog = new TambahDataPetugas(new javax.swing.JFrame(), true, null);
