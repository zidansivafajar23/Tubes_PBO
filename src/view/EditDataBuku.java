 ...
 * @author delll
 */
public class EditDataBuku extends javax.swing.JDialog {

    /**
     * Creates new form EditDataBuku
     */
    Buku buku;
    User user;

    public EditDataBuku(java.awt.Frame parent, boolean modal, User user, Buku buku) {
        super(parent, modal);
        this.buku = buku;
        this.user = user;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditDataBuku.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditDataBuku dialog = new EditDataBuku(new javax.swing.JFrame(), true, null, null);
