...
public class MenuUtamaKepala extends javax.swing.JFrame {
    ...
    public MenuUtamaKepala(KepalaPerpus m) {
        ...
        pn_content.add(new DashboardKepalaPerpus(user));
        pn_content.repaint();
    ...
    public void setTampilanMenu(String namaMenu) throws SQLException{
        if (namaMenu == "menu1"){
            ...
            pn_content.removeAll();
            pn_content.add(new DetailKepalaPerpus(user));
            pn_content.repaint();
            pn_content.revalidate();
    ...
    private void initComponents() {
        ...
        lb_Dashboard4.setText("Manajemen Petugas");
    ...
    private void menu1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menu1MouseClicked
        ...
        try {
            ...
            Logger.getLogger(MenuUtamaKepala.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuUtamaKepala.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
