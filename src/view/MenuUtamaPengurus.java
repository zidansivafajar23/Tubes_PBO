...
public class MenuUtamaPengurus extends javax.swing.JFrame {
    ...
    public MenuUtamaPengurus(PengurusPerpus p) {
        user = p;
        initComponents();
    ...
    public void setTampilanMenu(String namaMenu) throws SQLException{
        if (namaMenu == "menu1"){
            ...
            pn_content.removeAll();
            pn_content.add(new DataBukuPetugas(user));
            pn_content.repaint();
            pn_content.revalidate();
        } else if (namaMenu == "menu3"){
            pn_content.removeAll();
            pn_content.add(new DaftarPeminjamanPetugas(user));
            pn_content.repaint();
            pn_content.revalidate();
            ...
            pn_content.removeAll();
            pn_content.add(new DataMemberPetugas(user));
            pn_content.repaint();
            pn_content.revalidate();
        }
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuUtamaPengurus(null).setVisible(true);
            }
        });
    }
